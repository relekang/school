...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('tags_tag', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tag_creator', to=orm['auth.User'])),
            ('saved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tag_saved_by', to=orm['auth.User'])),
