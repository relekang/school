...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('notes_note', (
            ...
            ('saved_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='saved_by', to=orm['auth.User'])),
    ...
    models = {
        ...
        'notes.note': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'saved_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'saved_by'", 'to': "orm['auth.User']"}),
